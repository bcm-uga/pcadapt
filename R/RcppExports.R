...
#' @export
#' 
displacement <- function(local_centroids, global_centroids, popUnique, admixed) {
    .Call('_pcadapt_displacement', PACKAGE = 'pcadapt', local_centroids, global_centroids, popUnique, admixed)
}
