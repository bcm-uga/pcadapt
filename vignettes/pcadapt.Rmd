...
### F. Detecting local adaptation with pooled sequencing data
...
Computation of PCs and of P-values accounts for missing values. Missing values should be encoded by a single character (e.g. 9) different from 0, 1 or 2.


### H.2. Association between PCs and outliers
...
### H.3 Component-wise genome scan
