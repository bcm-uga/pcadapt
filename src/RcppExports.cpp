...
// multLinReg
NumericMatrix multLinReg(SEXP obj, const NumericMatrix& lookup_scale, const IntegerMatrix& lookup_byte, const IntegerVector& ind_col, const arma::mat& u);
RcppExport SEXP _pcadapt_multLinReg(SEXP objSEXP, SEXP lookup_scaleSEXP, SEXP lookup_byteSEXP, SEXP ind_colSEXP, SEXP uSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type obj(objSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(multLinReg(obj, lookup_scale, lookup_byte, ind_col, u));
    return rcpp_result_gen;
END_RCPP
}
// nb_nona
